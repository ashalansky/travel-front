  ...
  return (
    <Grid container spacing={3}>
      <Grid item xs={12} sm={5}>
        <PeopleTab cities={props.cities} flightPlans={props.flightPlans} updateFlightPlans={props.updateFlightPlans} updateCityCode={props.updateCityCode} setPassenger={props.setPassenger}></PeopleTab>
      </Grid>
